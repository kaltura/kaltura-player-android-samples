...
import com.kaltura.playkit.samples.broadpeak.databinding.ActivityConfigurationBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.run {
            ...
            btApply.setOnClickListener {
                ...
                ConfigurationProvider.setFileFormats(if (etFileFormats.text.length > 0) etFileFormats.text.toString() else null)
