...
import com.kaltura.playkit.samples.mediaplaybackpreview.preview.GetPreviewFromSprite
...
class MainActivity : AppCompatActivity() {
    ...
    var mediaArray: List<String>  = ArrayList(listOf("922976","918331","918330","918329","918327",
